...
aln_stats$bases_trimmed_cat <- cut(aln_stats$bases_trimmed, c(-Inf, 0:5, Inf),
                                   c(0:5, '>5'))
aln_stats$gaps_at_front_of_read_cat <- cut(aln_stats$gaps_at_front_of_read, c(-Inf, 0:5, Inf),
                                   c(0:5, '>5'))
