...
fig.cap2 <- "Figure: Probability of small bins resulting from sequencing errors in the PIDs of larger bins."
```
...
```{r, dpi=300, fig.width=7, fig.height=7, fig.cap=fig.cap1, fig.path=figure_path}
print(p1)
```
...
```{r, dpi=300, fig.width=7, fig.height=4, fig.cap=fig.cap1_1, fig.path=figure_path}
print(p1_1)
```
