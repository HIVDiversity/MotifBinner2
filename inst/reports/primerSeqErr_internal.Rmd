...
denominator_for_indels <- sum(dat$count) - n_deletions
del_rate <- subset(dat, from == 'del', select = 'count', drop=T)/denominator_for_indels
ins_rate <- subset(dat, from == 'ins', select = 'count', drop=T)/denominator_for_indels
