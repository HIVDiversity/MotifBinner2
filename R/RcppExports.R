...
gapQualityTweaker <- function(reads, q_mat) {
    .Call('MotifBinner2_gapQualityTweaker', PACKAGE = 'MotifBinner2', reads, q_mat)
}

score_alignment_positions <- function(reads, q_mat) {
    .Call('MotifBinner2_score_alignment_positions', PACKAGE = 'MotifBinner2', reads, q_mat)
}
